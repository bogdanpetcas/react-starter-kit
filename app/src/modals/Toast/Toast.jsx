...
class Toast extends React.Component {
  ...
  render() {
    const icon = this.getIcon(this.props.role);
    let className = `toast ${this.props.role} small`;
    ...
    return (
      <div id="toastMessage" className={className} role="alert" aria-live="assertive" aria-atomic="true">
        <div className="toast-header no-title">
          {icon}
          <small></small>
        </div>
